...
if(MONO_USE_SYSTEM_RUNTIME_FOR_TOOLS)
  ...
  if(MONO_HOST_WINDOWS)
    set(MONO_TOOLS_RUNTIME_HOST "${CMAKE_BINARY_DIR}/runtime/tools-mono.cmd")
    file(WRITE "${MONO_TOOLS_RUNTIME_HOST}"
"@echo off
rem Generated by CMake -- do not edit.
rem The build's managed tools run on a mono that is not the one this build
rem produces, so MONO_PATH has to go: it points at mcs/class/lib/build, whose
rem mscorlib.dll belongs to this tree and not to the runtime below, and mono
rem rejects that pairing outright.
set \"MONO_PATH=\"
\"${_tools_mono}\" %*
exit /b %ERRORLEVEL%
")
...
")
  ...
  set(MONO_TOOLS_RUNTIME ${MONO_RUNTIME_COMMAND})
  ...
  file(REMOVE "${CMAKE_BINARY_DIR}/runtime/tools-mono"
              "${CMAKE_BINARY_DIR}/runtime/tools-mono.cmd")
endif()
