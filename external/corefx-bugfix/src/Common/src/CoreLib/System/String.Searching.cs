...
namespace System
{
    public partial class String
    {
        ...
        //
        public int IndexOf(char value) => SpanHelpers.IndexOf(ref m_firstChar, value, Length);
        ...
        public unsafe int IndexOf(char value, int startIndex, int count)
        {
            ...
            int result = SpanHelpers.IndexOf(ref Unsafe.Add(ref m_firstChar, startIndex), value, count);
        ...
        //
        public int LastIndexOf(char value) => SpanHelpers.LastIndexOf(ref m_firstChar, value, Length);
        ...
        public unsafe int LastIndexOf(char value, int startIndex, int count)
        {
            ...
            int result = SpanHelpers.LastIndexOf(ref Unsafe.Add(ref m_firstChar, startSearchAt), value, count);
