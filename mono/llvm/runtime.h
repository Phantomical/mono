...
/// Returns an already-published entry for p method, or NULL if it is not ready.
/// This does not compile, block, or publish anything.
void *mono_llvm_jit_lookup_method (MonoMethod *method, MonoDomain *domain);
