/**
 * \file
 * \brief Eliminating a vtable field read against the class its symbol names.
 *
...
#ifndef MONO_LLVM_PASSES_ELIMINATE_VTABLE_HPP
#define MONO_LLVM_PASSES_ELIMINATE_VTABLE_HPP
