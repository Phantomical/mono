...
{
	/*
	 * Named, because function_ref does not own what it points at: built inline
	 * in the initializer below, each of these would be dead before the call.
	 */
	...
	return mono::translate_body (target, method, published);
}
