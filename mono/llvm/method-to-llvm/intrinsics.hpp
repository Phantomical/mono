...
/// System.Numerics.Vector4 and Vector2's rows, kept in
/// method-to-llvm/simd-numerics.cpp.
...
/// System.Runtime.Intrinsics.X86 rows, kept in simd-x86-intrinsics.cpp.
llvm::ArrayRef<BuiltinBody> simd_x86_bodies ();
