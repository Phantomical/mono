...
private:
	...
	/// Parameter values already loaded for a body this backend writes, so a body
	/// reading one parameter several times still gets one load.
	llvm::DenseMap<unsigned, llvm::Value *> written_body_args;
...
private:
	...
	/// The value of parameter i, for a body this backend writes rather than
	/// translates from IL.
