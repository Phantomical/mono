...
/* The engine's own helpers, which the opcode bodies share. The EE callback table
 * below is generated by pasting `interp_` in front of each name in ee.h, so
 * interp_arm_tier_counter has to answer to that name here. */
using mono::interp::frame_data_allocator_free;
using mono::interp::frame_data_allocator_init;
using mono::interp::compute_arg_offset;
using mono::interp::get_arg_offset;
using mono::interp::get_arg_offset_fast;
using mono::interp::get_virtual_method;
using mono::interp::interp_arm_tier_counter;
