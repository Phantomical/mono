...
ICALL_EXPORT void ves_icall_System_Runtime_RuntimeImports_Memcpy (guint8*, guint8*, size_t);
...
#else
ICALL_EXPORT void ves_icall_System_Runtime_RuntimeImports_Memmove_wbarrier (guint8*, guint8*, size_t, MonoType*);
#endif
